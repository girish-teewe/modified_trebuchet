...
//        protected final ImmutableIndex mAlphabeticIndex;
        ...
        private final boolean mEnableSecondaryLocalePinyin = false;
...
//                    .getImmutableIndex();
            mAlphabeticIndexBucketCount = 0;//mAlphabeticIndex.getBucketCount();
            mNumberBucketIndex = 0;//mAlphabeticIndexBucketCount - 1;
        }
        ...
        public int getBucketIndex(String name) {
            ...
            final int bucket = -1;//mAlphabeticIndex.getBucketIndex(name);
            if (bucket < 0) {
                return -1;
            }
        ...
        public String getBucketLabel(int bucketIndex) {
            ...
            return EMPTY_STRING;//mAlphabeticIndex.getBucketLabel(bucketIndex);
        }
